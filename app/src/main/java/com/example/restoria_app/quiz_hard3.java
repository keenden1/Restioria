...
public class quiz_hard3 extends AppCompatActivity {
    private TextView countdownTextView;
    private CountDownTimer countDownTimer;
    private boolean isTimerPaused = false;
    private long timeRemaining;
    private TextView button_hard_1b,button_hard_2b,button_hard_3b,questionhard3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_hard3);
        ...
        button_hard_1b= findViewById(R.id.button_hard_1b);
        button_hard_2b= findViewById(R.id.button_hard_2b);
        button_hard_3b= findViewById(R.id.button_hard_3b);
        questionhard3 = findViewById(R.id.question_hard_3);

        int totalQuestions = 5;
        int randomQuestionNumber = (int) (Math.random() * totalQuestions) + 1;
        String randomQuestionPath = "hard/questions3/question" + randomQuestionNumber;
        ...
        button_hard_1b.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                databaseRef.child(randomQuestionPath).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            button_hard_1b.setBackgroundResource(R.drawable.border3);
                            button_hard_2b.setEnabled(false);
                            button_hard_3b.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
                                String userId = currentUser.getUid();
                                DatabaseReference userRef = databaseRef.child("users").child(userId);
                                userRef.child("score").child("HardLevel_3").setValue(1);
                            }
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Intent intent = new Intent(quiz_hard3.this, quiz_hard4.class);
                                    startActivity(intent);
                                }
                            }, 1000);
                        }else{
                            button_hard_1b.setBackgroundResource(R.drawable.border4);
                            button_hard_2b.setEnabled(false);
                            button_hard_3b.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
                                String userId = currentUser.getUid();
                                DatabaseReference userRef = databaseRef.child("users").child(userId);
                                userRef.child("score").child("HardLevel_3").setValue(0);
                            }
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
        ...
        button_hard_2b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check the condition in Firebase Realtime Database
                DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference();
                ...
                databaseRef.child(randomQuestionPath).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            button_hard_2b.setBackgroundResource(R.drawable.border3);
                            button_hard_1b.setEnabled(false);
                            button_hard_3b.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
                                String userId = currentUser.getUid();
                            ...
                            button_hard_2b.setBackgroundResource(R.drawable.border4);
                            button_hard_1b.setEnabled(false);
                            button_hard_3b.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
        ...
        button_hard_3b.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check the condition in Firebase Realtime Database
                DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference();
                ...
                databaseRef.child(randomQuestionPath).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            button_hard_3b.setBackgroundResource(R.drawable.border3);
                            button_hard_1b.setEnabled(false);
                            button_hard_2b.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
                            ...
                            button_hard_3b.setBackgroundResource(R.drawable.border4);
                            button_hard_1b.setEnabled(false);
                            button_hard_2b.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(quiz_hard3.this, hardmode.class);
                        startActivity(intent);
                    }
                })
