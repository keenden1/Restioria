...
public class quiz_medium5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_medium5);
        ...
        button_easy_1 = findViewById(R.id.button_medium_1d);
        button_easy_2 = findViewById(R.id.button_medium_2d);
        button_easy_3 = findViewById(R.id.button_medium_3d);
        questioneasy = findViewById(R.id.question_medium_5);

        int totalQuestions = 5;
        int randomQuestionNumber = (int) (Math.random() * totalQuestions) + 1;
        String randomQuestionPath = "medium/questions5/question" + randomQuestionNumber;
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            ...
                            if (currentUser != null) {
                                ...
                                userRef.child("score").child("MediumLevel_5").setValue(1);
                            }
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Intent intent = new Intent(quiz_medium5.this, score_medium.class);
                            ...
                            if (currentUser != null) {
                                String userId = currentUser.getUid();
                                DatabaseReference userRef = databaseRef.child("users").child(userId);
                                userRef.child("score").child("MediumLevel_5").setValue(0);
                            }
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(quiz_medium5.this, mediummode.class);
                        startActivity(intent);
                    }
                })
