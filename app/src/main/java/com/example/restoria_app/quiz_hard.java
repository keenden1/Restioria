...
public class quiz_hard extends AppCompatActivity {
    private TextView countdownTextView;
    private CountDownTimer countDownTimer;
    private boolean isTimerPaused = false;
    private long timeRemaining;
    private TextView button_hard_1,button_hard_2,button_hard_3,questionhard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_hard_1= findViewById(R.id.button_hard_1);
        button_hard_2= findViewById(R.id.button_hard_2);
        button_hard_3= findViewById(R.id.button_hard_3);
        questionhard = findViewById(R.id.question_hard_1);

        int totalQuestions = 5;
        int randomQuestionNumber = (int) (Math.random() * totalQuestions) + 1;
        String randomQuestionPath = "hard/questions/question" + randomQuestionNumber;
        ...
        button_hard_1.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                databaseRef.child(randomQuestionPath).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            button_hard_1.setBackgroundResource(R.drawable.border3);
                            button_hard_2.setEnabled(false);
                            button_hard_3.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
                                String userId = currentUser.getUid();
                                DatabaseReference userRef = databaseRef.child("users").child(userId);
                                userRef.child("score").child("HardLevel_1").setValue(1);
                            }
        ...
        button_hard_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check the condition in Firebase Realtime Database
                DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference();
                ...
                databaseRef.child(randomQuestionPath).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            button_hard_2.setBackgroundResource(R.drawable.border3);
        ...
        button_hard_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Check the condition in Firebase Realtime Database
                DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference();
                ...
                databaseRef.child(randomQuestionPath).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            button_hard_3.setBackgroundResource(R.drawable.border3);
                            button_hard_1.setEnabled(false);
                            button_hard_2.setEnabled(false);
                            FirebaseUser currentUser = FirebaseAuth.getInstance().getCurrentUser();
                            if (currentUser != null) {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(quiz_hard.this, hardmode.class);
                        startActivity(intent);
                    }
                })
