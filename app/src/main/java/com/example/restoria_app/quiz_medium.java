...
public class quiz_medium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_easy_1= findViewById(R.id.button_medium_1);
        button_easy_2= findViewById(R.id.button_medium_2);
        button_easy_3= findViewById(R.id.button_medium_3);
        questioneasy = findViewById(R.id.question_medium_1);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (questionA != null && expectedAnswer != null && questionA.equals(expectedAnswer)) {
                            ...
                            if (currentUser != null) {
                                ...
                                userRef.child("score").child("MediumLevel_1").setValue(1);
                            }
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    Intent intent = new Intent(quiz_medium.this, quiz_medium2.class);
                            ...
                            if (currentUser != null) {
                                String userId = currentUser.getUid();
                                DatabaseReference userRef = databaseRef.child("users").child(userId);
                                userRef.child("score").child("MediumLevel_1").setValue(0);
                            }
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(quiz_medium.this,  mediummode.class);
                        startActivity(intent);
                    }
                })
